...
# Denylistable Component

This component provides denylist functionality allowing authorized users to
...
mod MyContract {
    ...
    fn transfer(ref self: ContractState, to: ContractAddress, amount: u256) {
        self.denylistable.assert_not_denylisted(get_caller_address());
        // Transfer logic here
    }
}
```
